...
from kernel_creation import convert_acid_kernel, convert_acid_quad
from kernel_creation import compute_test_matrix, compute_K_matrix
...
for name in ["0", "1", "2"]:
    ...
    #list_converted = convert_spectral_kernel_trig(sequences, list_trig)
    ...
    #list_converted_test = convert_spectral_kernel_trig(sequences_test, list_trig)
    ...
    alpha = logistic_kernel_regression(K, label_train, lamb_log, 30, K_test_train, label_test_train)
...
save_label(0, list_labels_svm,"results/KSVM_0000001_10-10_acid_quad.csv" )
